...
const char* SERVER_URL = "http://192.168.1.100:5000";  // Central server IP
const char* DEVICE_ID = "CLASSROOM_001";
const char* API_KEY = "your_secure_api_key_here";
...
const int POWER_OFF_DELAY = 180;        // 3 minutes - auto power off if idle and unbooked
const int SENSOR_CHECK_INTERVAL = 5;    // Check sensor every 5 seconds

// Pin Configuration
const int ULTRASONIC_TRIGGER_PIN = D7;  // GPIO pin for trigger
const int ULTRASONIC_ECHO_PIN = D8;     // GPIO pin for echo
const int RELAY_PIN = D5;                // GPIO pin for relay control (LOW = ON, HIGH = OFF)
